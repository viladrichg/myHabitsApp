...
import { THEMES, ThemeStyle, CalendarStyle, SummaryDisplayStyle } from '@/lib/database/types';
...
export default function SettingsScreen() {
  ...
  const summaryStyleOptions: { value: SummaryDisplayStyle; name: string }[] = [];
        ...
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16 }}>
          ...
          <View style={{ backgroundColor: theme.card, borderRadius: 16, padding: 16, marginBottom: 16 }}>
            ...
            <Pressable
              ...
              style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 0, borderBottomColor: theme.border }}
            >
