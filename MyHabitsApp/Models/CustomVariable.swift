...
let builtInVariables: [BuiltInVariable] = [
    .init(fieldKey: "feina",  label: "Feina",  colorHex: "#0077BB", type: "boolean"),
    .init(fieldKey: "casa", label: "Casa", colorHex: "#EE7733", type: "boolean"),
    .init(fieldKey: "fum",          label: "Fum",            colorHex: "#CC3311", type: "boolean"),
    .init(fieldKey: "gat",          label: "Gat",            colorHex: "#EE3377", type: "boolean"),
    .init(fieldKey: "meditació",   label: "Meditació",     colorHex: "#009988", type: "boolean"),
    ...
    .init(fieldKey: "Pitells",      label: "Pitells",        colorHex: "#8b5cf6", type: "counter"),
]
